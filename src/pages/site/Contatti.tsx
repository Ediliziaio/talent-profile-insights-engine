...
const PERCORSI = [
  {
    ...
    desc: 'Ti mostriamo quanti profili compatibili ci sono già nel marketplace per il ruolo che devi coprire.',
    to: '/marketplace-talenti-edili',
    label: 'Vedi il marketplace',
  },
  {
    icon: Briefcase,
  ...
  return (
    <>
      <Seo
        ...
        description="Parla con noi di selezione del personale edile: demo del Talent Profile System, marketplace o servizio di ricerca e selezione. Rispondiamo entro 24 ore lavorative."
        path={PATH}
        jsonLd={jsonLd}
      />
